...
| Process steps | "spawn reviewer", "document solution" | **Must become commands** (`/workflows:review`, `/workflows:compound`) |
...
See `specifications/compound-engineering-adoption.md` "The Integration Problem" section for the concrete migration plan replacing instruction-based steps with commands.
