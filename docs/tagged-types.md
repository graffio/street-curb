...
1. Add or edit a definition in `type-definitions/*.type.js` inside the owning package.
2. Run `yarn types:generate` (or `yarn types:watch`) to regenerate the corresponding module at the path listed in
   `modules/cli-type-generator/type-mappings.js`.
3. Import constructors from the generated module and call them without `new`.

### Type-definitions locations

| Source directory                                | Types                                      | Output directory                         |
|-------------------------------------------------|--------------------------------------------|------------------------------------------|
| `modules/quicken-type-definitions/`             | 10 (Account, Transaction, Category, etc.)  | `modules/quicken-web-app/src/types/`     |
| `modules/quicken-web-app/type-definitions/`     | 15 (TransactionFilter, Action, View, etc.) | `modules/quicken-web-app/src/types/`     |
| `modules/curb-map/type-definitions/`            | 11                                         | `modules/curb-map/src/types/`            |
| `modules/cli-type-generator/type-definitions/`  | 6                                          | `modules/cli-type-generator/src/types/`  |
| `modules/cli-qif-to-sqlite/type-definitions/`   | 3                                          | `modules/cli-qif-to-sqlite/src/types/`   |
| `modules/cli-style-validator/type-definitions/` | 3                                          | `modules/cli-style-validator/src/types/` |
| `modules/ast/type-definitions/`                 | 1                                          | `modules/ast/src/types/`                 |
| `modules/design-system/type-definitions/`       | 1                                          | `modules/design-system/src/types/`       |
| `modules/functional/type-definitions/`          | 1                                          | `modules/functional/src/types/`          |

Note: `quicken-type-definitions` is a standalone directory (not inside a module) because these types are shared domain
entities. The mapping is configured in `modules/cli-type-generator/type-mappings.js`.
...
**See also:** `modules/cli-type-generator/tagged-types.md` for generator implementation architecture and internals.
