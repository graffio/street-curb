...
test('Signatures.toNormalizedPayee', async t => {
    t.test('Given a payee string with mixed case and whitespace', async t =>
        t.test('When normalizing', async t => {
            const result = Signatures.toNormalizedPayee('  ACME  Corporation   Inc  ')
    ...
    t.test('Given a null payee', async t =>
        t.test('When normalizing', async t => {
            const result = Signatures.toNormalizedPayee(null)
    ...
    t.test('Given an undefined payee', async t =>
        t.test('When normalizing', async t => {
            const result = Signatures.toNormalizedPayee(undefined)
...
test('Signatures.buildSecuritySignature', async t => {
    t.test('Given a security with a symbol', async t =>
        t.test('When generating signature', async t => {
            ...
            const result = Signatures.buildSecuritySignature(security)
...
test('Signatures.buildBankTransactionSignature', async t => {
    t.test('Given a bank transaction', async t =>
        t.test('When generating signature', async t => {
            ...
            const result = Signatures.buildBankTransactionSignature(txn, stableAccountId)
...
test('Signatures.buildInvestmentTransactionSignature', async t => {
    t.test('Given an investment transaction with stable IDs', async t =>
        t.test('When generating signature', async t => {
            ...
            const result = Signatures.buildInvestmentTransactionSignature(txn, stableAccountId, stableSecurityId)
...
test('Signatures.buildCategorySignature', async t => {
    t.test('Given a category with a name', async t =>
        t.test('When generating signature', async t => {
            const category = { name: 'Groceries' }
            const result = Signatures.buildCategorySignature(category)
...
test('Signatures.buildTagSignature', async t => {
    t.test('Given a tag with a name', async t =>
        t.test('When generating signature', async t => {
            const tag = { name: 'Vacation' }
            const result = Signatures.buildTagSignature(tag)
...
test('Signatures.buildSplitSignature', async t => {
    t.test('Given a split with transaction and category stable IDs', async t =>
        t.test('When generating signature', async t => {
            ...
            const result = Signatures.buildSplitSignature(split, transactionStableId, categoryStableId)
...
test('Signatures.buildPriceSignature', async t => {
    t.test('Given a security stable ID and date', async t =>
        t.test('When generating signature', async t => {
            const securityStableId = 'sec_00123'
            const date = '2024-03-15'
            const result = Signatures.buildPriceSignature(securityStableId, date)
