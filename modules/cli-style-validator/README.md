...
**Note:** If the function is an inline callback (Promise executor, .map callback), fix single-level-indentation first - extraction will create a named function that needs @sig.
