...
tap.test('mergeWithKey', t => {
    t.test(`Given o1 = ${o1s} and o2 = ${o2s} and f that adds just 'e' values`, t => {
        t.test('When I call mergeWithKey(f, o1, o2)', t => {
            t.same(mergeWithKey(concatEValues, o1, o2), expected1, `Then I should get ${expected1s}`)
            t.end()
        })

        t.test('But when I reverse o1 and o2 and call mergeWithKey(f, o2, o1)', t => {
            t.same(mergeWithKey(concatEValues, o2, o1), expected2, `Then I should get ${expected2s}`)
            t.end()
        })
