...
tap.test('ramda-like equals', t => {
    t.test('tests for deep equality of its operands', t => {
    ...
    t.test('considers equal Boolean primitives equal', t => {
    ...
    t.test('considers equivalent Boolean objects equal', t => {
    ...
    t.test('never considers Boolean primitive equal to Boolean object', t => {
    ...
    t.test('considers equal number primitives equal', t => {
    ...
    t.test('considers equivalent Number objects equal', t => {
    ...
    t.test('considers equivalent String objects equal', t => {
    ...
    t.test('never considers string primitive equal to String object', t => {
    ...
    t.test('handles objects', t => {
        ...
        t.notOk(equals({ a: 2, b: 3, c: 1 }, { a: 2, b: 3 }), '{ a: 2, b: 3, c: 1 }, { a: 2 does not equals b: 3 })')
        t.end()
    })

    t.test('considers equivalent Arguments objects equal', t => {
        const a = (function () {
            return arguments
        })()
        const b = (function () {
    ...
    t.test('considers equivalent Error objects equal', t => {
    ...
    t.test('requires that both objects have the same enumerable properties with the same values', t => {
        const a1 = []
        const a2 = []
        a2.x = 0
    ...
    t.test('compares Promise objects by identity', t => {
    ...
    t.test('compares Map objects by value', t => {
        const map12 = new Map([
            [1, 'a'],
            [2, 'b'],
        ])
    ...
    t.test('compares Set objects by value', t => {
        ...
        t.ok(equals(new Set([1, 2]), new Set([2, 1])), 'Two Sets are equals despite the order the values were array')
        t.ok(
    ...
    t.test('compares WeakMap objects by identity', t => {
        const m = new WeakMap([])
    ...
    t.test('compares WeakSet objects by identity', t => {
        const s = new WeakSet([])
