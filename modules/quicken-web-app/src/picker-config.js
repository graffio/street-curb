...
const PickerConfig = {
    reports: {
        ...
        items: [
            ...
            T.toReportPickerItem('engine_running_balance', 'engine_running_balance', 'Running Balance'),
            T.toReportPickerItem('engine_bank_accounts', 'engine_bank_accounts', 'Bank Accounts'),
        ],
    },
