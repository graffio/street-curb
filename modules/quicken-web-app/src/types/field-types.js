...
const FieldTypes = {
    ...
    sourceName         : /^[a-z_][a-zA-Z0-9_]*$/,        // query source name: food, income_q1, securityType
    groupDimension     : /^(month|quarter|year|category|account|payee|security|securityType|goal)$/,
