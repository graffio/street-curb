...
const investmentColumns = LookupTable([
    ...
    ColumnDefinition.from({ id: 'balance'   , accessorKey: 'runningBalance'              , header: 'Balance' , size: 100, cell: CurrencyCell, enableResizing: false, meta: { searchable: false, showRunningTotal: true  }}),
], ColumnDefinition, 'id')
