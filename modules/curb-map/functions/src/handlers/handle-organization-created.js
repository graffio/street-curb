 ...
 * @sig handleOrganizationCreated :: (FirestoreContext, ActionRequest) -> Promise<void>
 */
const handleOrganizationCreated = async (fsContext, actionRequest) => {
    ...
    const memberData = Member.toFirestore(
        { userId: actorId, displayName: actor.displayName, role: 'admin', addedAt: date, addedBy: actorId },
