...
const loadConfig = configPath => {
    if (!configPath) {
        ...
        console.error('Usage: node 000-bootstrap-service-account.tap.js <config-path>')
        process.exit(1)
    }
...
tap.test('Given a migration config that defines the bootstrap service account', t => {
