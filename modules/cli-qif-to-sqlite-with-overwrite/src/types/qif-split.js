...
// ABOUTME: Auto-generated from modules/cli-qif-to-sqlite-with-overwrite/type-definitions/qif-split.type.js - do not edit manually

/** {@link module:QifSplit} */
/*  QifSplit generated from: modules/cli-qif-to-sqlite-with-overwrite/type-definitions/qif-split.type.js
 *
 *  amount  : "Number",
 *  category: "String",
 *  memo    : "String?"
 ...
 */
const QifSplit = function QifSplit(amount, category, memo) {
    const constructorName = 'QifSplit(amount, category, memo)'
...
const qifsplitToString = function () {
    return `QifSplit(${R._toString(this.amount)}, ${R._toString(this.category)}, ${R._toString(this.memo)})`
}
...
QifSplit._from = _input => {
    ...
    return QifSplit(amount, category, memo)
}
