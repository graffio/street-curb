// ABOUTME: Security database operations for QIF import
// ABOUTME: Handles security CRUD with symbol and name lookups

// COMPLEXITY-TODO: cohesion-structure — Pre-existing debt, database module exports (expires 2026-01-13)
// COMPLEXITY-TODO: vague-prefix — Pre-existing debt, database getter convention (expires 2026-01-13)
// COMPLEXITY-TODO: exports — Pre-existing debt, database module exports (expires 2026-01-13)

import { map } from '@graffio/functional'
import { hashFields } from '@graffio/functional/src/generate-entity-id.js'
import { QifEntry, Security } from '../../types/index.js'
 ...
 * @sig insertSecurity :: (Database, QifEntry.Security) -> String
 */
const insertSecurity = (db, securityEntry) => {
    if (!QifEntry.Security.is(securityEntry))
        throw new Error(`Expected QifEntry.Security; found: ${JSON.stringify(securityEntry)}`)
 ...
 * @sig importSecurities :: (Database, [QifEntry.Security]) -> [String]
 */
