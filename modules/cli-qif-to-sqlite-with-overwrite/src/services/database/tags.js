// ABOUTME: Tag database operations for QIF import
// ABOUTME: Handles tag CRUD with color and description fields
...
import { QifEntry, Tag } from '../../types/index.js'
 ...
 * @sig insertTag :: (Database, QifEntry.Tag) -> String
 */
const insertTag = (db, tagEntry) => {
    if (!QifEntry.Tag.is(tagEntry)) throw new Error(`Expected QifEntry.Tag; found: ${JSON.stringify(tagEntry)}`)
 ...
 * @sig importTags :: (Database, [QifEntry.Tag]) -> [String]
 */
