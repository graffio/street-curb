...
test('Daily Portfolios', t => {
    t.test('Given a fresh database', t => {
        ...
        t.test('When I insert a bank transaction', t => {
            const account = QifEntry.Account.from({
            ...
            const transaction = QifEntry.TransactionBank.from({
    ...
    t.test('Given a database with investment transactions and lots', t => {
        ...
        t.test('When I insert investment data', t => {
            ...
            // Create security
            const security = QifEntry.Security.from({ name: 'Apple Inc', symbol: 'AAPL', type: 'Stock' })
            ...
            // Add initial price
            const price1 = QifEntry.Price.from({
                security: 'Apple Inc',
                symbol: 'AAPL',
                date: new Date('2024-01-16'),
                price: 200,
            ...
            // Add later price
            const price2 = QifEntry.Price.from({
                security: 'Apple Inc',
                symbol: 'AAPL',
            ...
            const dummyTxn = QifEntry.TransactionBank.from({
                account: 'Investment Account',
                date: new Date('2024-01-20'),
                amount: 0,
                payee: 'Dummy',
