...
| React/Redux philosophy, handler patterns                   | `.claude/style-cards/react-component.md` | Task file `style_card` field |
| Selector rules, layer boundaries                           | `.claude/style-cards/selector.md`        | Task file `style_card` field |
| JS module patterns, naming                                 | `.claude/style-cards/js-module.md`       | Task file `style_card` field |
| Test structure                                             | `.claude/style-cards/test-file.md`       | Task file `style_card` field |
