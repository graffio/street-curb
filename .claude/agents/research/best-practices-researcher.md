...
2. **Identify Relevant Skills**:
   ...
   - JavaScript/Functional → `.claude/conventions.md`, `.claude/preferences.md`
...
- **Project conventions**: "The project conventions.md specifies..." (highest authority - project-specific)
