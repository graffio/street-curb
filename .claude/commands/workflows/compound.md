...
### 7. **Optional: Specialized Agent Invocation** (Post-Documentation)
   ...
   - **code_quality** → `code-simplicity-reviewer`
   - Any code-heavy issue → `jeff-js-reviewer` + `code-simplicity-reviewer`
...
Specialized Agent Reviews (Auto-Triggered):
  ...
  ✓ jeff-js-reviewer: Code examples meet project conventions
...
### Code Quality & Review
- **jeff-js-reviewer**: Reviews code examples for project conventions (functional JS, cohesion groups)
